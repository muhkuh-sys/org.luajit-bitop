...
docker exec ${ID} bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1610_x86.tar.gz --gzip --directory /tmp/work/build_linux32/lua5.1/bitop/install .'
...
docker exec ${ID} bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1610_x86_64.tar.gz --gzip --directory /tmp/work/build_linux64/lua5.1/bitop/install .'
