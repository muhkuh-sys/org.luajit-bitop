...
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1610_x86_lua5.1.tar.gz --gzip --directory /tmp/work/build/linux/lua5.1/bitop/install .'
lxc exec ${CONTAINER} -- bash -c 'tar --create --file /tmp/work/build/build_ubuntu_1610_x86_lua5.2.tar.gz --gzip --directory /tmp/work/build/linux/lua5.2/bitop/install .'
