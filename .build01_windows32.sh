...
make
lua5.1 ${JONCHKI} --verbose debug --syscfg ${PRJ_DIR}/jonchki/jonchkisys.cfg --prjcfg ${PRJ_DIR}/jonchki/jonchkicfg.xml --distribution-id windows --cpu-architecture x86 --build-dependencies bitop/lua5.1-bitop-1.0.2.1.xml
popd
